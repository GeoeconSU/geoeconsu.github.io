...
│   ├── adip.png
│   └── ... (12 total)
├── insights/              - Legacy strategic brief PDFs (4 files)
│   ├── davos.pdf
│   ├── SaudiArabiaForeignInvestment.pdf
│   ├── Venezuela Crisis 2026.pdf
│   └── Rare Earth Chokepoint.pdf
├── pdfs/                  - New strategic briefs (auto-processed)
...
2. Commit and push: `git add pdfs/your-brief.pdf && git commit -m "Add brief" && git push`
